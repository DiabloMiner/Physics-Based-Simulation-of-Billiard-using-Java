...
public class RenderablePointLight extends RenderableLight {
    ...
    public static AssimpModel model = new AssimpModel("./src/main/resources/cube.obj", new Vector3f(0.0f));
    ...
    public void draw(ShaderProgram shaderProgram, Map.Entry<RenderInto, RenderParameters> flags) {
        model.draw(shaderProgram, new Matrix4f().identity().translate(pointLight.position).scale(0.05f), flags);
    }
