...
public class CubeMap extends Texture {
    ...
    public static FramebufferCubeMap fromEquirectangularMap(String filePath, int size, boolean flipImage) throws Exception {
        ...
        ShaderProgram shaderProgram = new ShaderProgram("IBLCubeMapVS", "IBLCubeMapGS", "EqMToCMFS");
        AssimpModel cube = new AssimpModel("./src/main/resources/skyboxCube.obj", new Matrix4f().identity());
    ...
    public static FramebufferCubeMap convoluteCubeMap(CubeMap cubeMap, int size) throws Exception {
        ...
        ShaderProgram shaderProgram = new ShaderProgram("IBLCubeMapVS", "IBLCubeMapGS", "ConvolutionFS");
        AssimpModel cube = new AssimpModel("./src/main/resources/skyboxCube.obj", new Matrix4f().identity());
    ...
    public static FramebufferCubeMap prefilterCubeMap(CubeMap cubeMap, int size) throws Exception {
        ...
        ShaderProgram shaderProgram = new ShaderProgram("IBLCubeMapVS", "IBLCubeMapGS", "PrefilteringFS");
        AssimpModel cube = new AssimpModel("./src/main/resources/skyboxCube.obj", new Matrix4f().identity());
