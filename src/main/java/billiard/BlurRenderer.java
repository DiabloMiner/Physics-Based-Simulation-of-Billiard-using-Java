...
public class BlurRenderer extends Renderer {
    ...
    static { try { blurShaderProgram = new ShaderProgram("SVS", "GaussianBlur"); } catch (Exception e) { e.printStackTrace(); } }
    ...
    public static ShaderProgram getBlurShaderProgram() throws Exception {
        if (blurShaderProgram == null) {
            blurShaderProgram = new ShaderProgram("SVS", "GaussianBlur");
        }
